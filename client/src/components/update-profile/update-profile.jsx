...
export function UpdateProfile(props) {
  ...
  const handleDeregister = e => {
    ...
    axios
      .delete(`https://myflixmovies.herokuapp.com/users/${user}`, {
        headers: { Authorization: `Bearer ${token}` }
      })
      .then(response => {
          ...
          <Row>
            <Col>
              ...
              <div className="deregister-div">
                ...
                <p className="deregister-div-warning">
                  Warning: this is irreversible, all account information
                  including your saved movies will be deleted.
                </p>
              </div>
